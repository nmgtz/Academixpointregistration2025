...
if (loginButton && registerButton) {
  loginButton.addEventListener("click", (e) => {
    ...
    // Show ONLY the login form CONTAINER (not the form itself)
    const loginFormContainer2 = document.getElementById("lg-form"); // Changed from "login-form" to "lg-form"
    if (loginFormContainer2) {
      loginFormContainer2.style.display = "block";
      console.log("Login form container displayed");
    } else {
