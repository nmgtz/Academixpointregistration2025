...
function _ensureAuthOverlay() {
  ...
  /* ── login-form wrapper (centering shell) ── */
...
function applyLandingStyles() {
  ...
  style.textContent = `
    ...
    /* The scrollable centering shell INSIDE the overlay */
...
function _startCanvasFallback() {
  ...
  canvas.style.cssText = "position:absolute;inset:0;width:100%;height:100%;z-index:0;display:block;";
  const ov = document.getElementById("axp-auth-overlay");
  if (ov) ov.insertBefore(canvas, ov.firstChild);
