...
if (loginButton && registerButton) {
  loginButton.addEventListener("click", (e) => {
    ...
    // CRITICAL: Show the parent login-form container FIRST
    const loginFormWrapper = document.querySelector(".login-form");
    if (loginFormWrapper) {
        loginFormWrapper.style.display = "block";
        console.log("Login form wrapper displayed"); // Debug log
    } else {
        console.error("Login form wrapper not found!");
    }
    ...
    // Show ONLY the login form container
    const loginFormContainer = document.getElementById("lg-form");
    if (loginFormContainer) {
        loginFormContainer.style.display = "block";
        console.log("Login form container displayed"); // Debug log
    } else {
  ...
  registerButton.addEventListener("click", (e) => {
    ...
    // Show ONLY the signup form CONTAINER (sp-form is already correct)
    const signupFormContainer = document.getElementById("sp-form");
    if (signupFormContainer) {
      signupFormContainer.style.display = "block";
      console.log("Signup form container displayed");
    } else {
      console.error("Signup form container (sp-form) not found!");
    }
  });
} else {
