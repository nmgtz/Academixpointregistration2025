...
function applyLandingStyles() {
  ...
  style.textContent = `
    ...
    /* When video bg is active, overlay becomes transparent */
    body:has(#axp-video-bg[style*="display: block"]) #axp-auth-overlay,
    body:has(#axp-canvas-bg[style*="display: block"]) #axp-auth-overlay {
      background: transparent;
    }

    /* Inner wrapper — horizontally centered via inline-block trick */
    ...
    /* Mobile: full width, no side padding gap */
...
function _startCanvasFallback() {
  ...
  canvas.style.cssText = "position:fixed;inset:0;width:100%;height:100%;z-index:2147483640;display:block;pointer-events:none;";
