...
function updateDashboardUI(data) {
  ...
  if (shareLinkText && data.schoolindex) {
    const schoolLink = `https://www.academixpoint.com/p/${data.schoolindex.toLowerCase()}-teachers-feeding-area.html`;
    shareLinkText.textContent = schoolLink;
  }

  // Setup share link click functionality
  const shareLinkSection = document.getElementById('shareLinkSection');
  if (shareLinkSection) {
    shareLinkSection.addEventListener('click', function() {
