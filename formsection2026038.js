...
window.axpShowRegisterNotice = function() {
  ...
  overlay.style.cssText = `
    position:fixed; top:0; left:0; width:100%; height:100%;
    background:rgba(6,12,28,0.92); z-index:999999999;
  ...
  overlay.innerHTML = `
    ...
    ">
      ...
      ">
        <p style="margin:0 0 12px; font-size:14.5px; font-weight:600; color:#f1f5f9; display:flex; align-items:center; gap:8px;">
          <i class="bi bi-check-circle-fill" style="color:#4ecca3; font-size:16px; flex-shrink:0;"></i>
          AcademixPoint is designed <u style="margin-left:4px;">exclusively</u> for:
        </p>
        <ul style="margin:0 0 16px; padding-left:20px; font-size:13.5px; color:#cbd5e1; line-height:2; list-style:none; padding-left:0;">
        ...
        <p style="margin:0 0 10px; font-size:14.5px; font-weight:600; color:#f87171; display:flex; align-items:center; gap:8px;">
          <i class="bi bi-x-circle-fill" style="color:#f87171; font-size:16px; flex-shrink:0;"></i>
          This platform is <u style="margin-left:4px;">NOT</u> for:
        </p>
        <ul style="margin:0; padding-left:0; font-size:13.5px; color:#94a3b8; line-height:2; list-style:none;">
          <li style="display:flex; align-items:center; gap:8px;">
            <i class="bi bi-x" style="color:#f87171; flex-shrink:0;"></i> Personal lesson plans
          </li>
          <li style="display:flex; align-items:center; gap:8px;">
            <i class="bi bi-x" style="color:#f87171; flex-shrink:0;"></i> Teaching schemes of work
          </li>
          <li style="display:flex; align-items:center; gap:8px;">
            <i class="bi bi-x" style="color:#f87171; flex-shrink:0;"></i> Personal notes or documents
          </li>
          <li style="display:flex; align-items:center; gap:8px;">
            <i class="bi bi-x" style="color:#f87171; flex-shrink:0;"></i> Any non-results school activity are free and no accounts needed
          </li>
        </ul>
      </div>
      ...
      ">
        ...
        ">
        I understand that AcademixPoint is <strong style="color:#4ecca3;">&nbsp;only for school exam results systems&nbsp;</strong>
