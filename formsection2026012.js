...
function _ensureAuthOverlay() {
  ...
  ov.style.cssText = [
    ...
    "width:100vw","height:100%","padding:20px 16px","box-sizing:border-box",
    "background:#060c1c","overflow-y:auto","overflow-x:hidden"
  ].join(";");
  ...
  loginForm.style.cssText = [
    ...
    "min-height:100%","box-sizing:border-box","z-index:10","padding:0"
  ].join(";");
...
function applyLandingStyles() {
  ...
  style.textContent = `
    ...
    /* .login-form is inside #axp-auth-overlay which controls visibility */
    /* Only hide .login-form that lives OUTSIDE our overlay (dead template remnants) */
    ...
    /* Form card — scrolls naturally, no forced full-height */
    .form-container {
...
function showMessage(message, success = true) {
  const visibleForm = document.querySelector("#axp-auth-overlay .form-container[style*='flex']") || document.querySelector(".form-container[style*='flex']");
