...
function renderResultsSection() {
    // File 1's section container — same ID used in navigateToSection()
    const cont = document.getElementById('section-results-reports')
...
function fetchReport() {
    // Called from navigateToSection('students-report') in File 1
    const cont = document.getElementById('section-students-report')
