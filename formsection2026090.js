...
const scriptURL = 'https://script.google.com/macros/s/AKfycbwDe05PPN9cNdbuPuXku8A_qIVLDL7jQdU7PJ5MV0886jE-jcYnNj8t-TpY05CWcH4K/exec';
...
function _axpCandNo(idx) {
  ...
  return `S${sid}-${String(idx+1).padStart(4,"0")}`;
}
...
window.axpFeedLoadRoster = async function() {
  ...
  try {
    ...
    window._axpFeed = {
      students:res.students, teacher:res.teacher||null,
    ...
    async()=>{
      ...
      try{
        ...
        if(res.status==="success"){
          ...
          _axpToast(`Marks submitted for ${filled} students!`,"success");
          axpAlert("Marks Submitted Successfully",
            `<div style="text-align:center;padding:8px 0;">
               <div style="font-size:48px;margin-bottom:8px;">✅</div>
               <div style="font-size:15px;font-weight:700;color:#10b981;margin-bottom:12px;">
                 ${filled} mark${filled!==1?"s":""} saved to the server</div>
               <div style="background:#f0fdf9;padding:10px 14px;font-size:13px;color:#1a1a2e;">
...
function _axpFeedShowSummary(submitted=false) {
  ...
  el.innerHTML=`
    ...
    <div style="overflow-x:auto;">
      <table class="axp-table" style="min-width:440px;">
        <thead><tr>
          <th>#</th><th>Cand. No.</th><th>Name</th>
  ...
  axpConfirm("Confirm Bulk Submission",
    ...
    async()=>{
      ...
      try{
        ...
        if(res.status==="success"){
          _showSectionMsg("axpBulkMsg",`${filled} marks submitted!`,"success");
  ...
  try {
    ...
    const fetches = subjects.map(sub =>
      _apiGet({ mode:"feedingRoster", schoolId:_appScriptSchoolId,
        ...
        .then(r => ({ subject:sub, students:(r.students||[]) }))
...
var _axpPDF = {
  ...
  drawRow(doc, cols, y, rowH, isHeader, isAlt) {
    ...
    for (const subjectName of checked) {
      ...
      const drawTableHeader = (y) => {
        return _axpPDF.drawRow(doc, [
          {text:"#",             width:COL.no,   align:"center", bold:true},
          {text:"Cand. No.",     width:COL.cand, align:"left",   bold:true},
          {text:"Student Name",  width:COL.name, align:"left",   bold:true},
          {text:"Sex",           width:COL.sex,  align:"center", bold:true},
          {text:"Score",         width:COL.score,align:"center", bold:true},
          {text:"Signature",     width:COL.sig,  align:"center", bold:true},
        ], y, HEADER_ROW_H, true, false);
      };
      ...
      students.forEach((s, idx) => {
        ...
        y = _axpPDF.drawRow(doc, [
          {text: idx+1,       width:COL.no,   align:"center"},
...
window.axpPrintGeneralSheet = async function() {
  ...
  try {
    ...
    */
    ...
    const buildCols = () => [
      {text:"#",           width:8,         align:"center", bold:true},
      {text:"Cand. No.",   width:28,        align:"left",   bold:true},
      {text:"Student Name",width:58,        align:"left",   bold:true},
    ...
    allStudents.forEach((student, idx) => {
      ...
      /* Fixed cells */
      const fixedCols = [
        {text: idx+1,                              width:8,  align:"center", color:[120,120,120]},
        {text: student.candidateNo,                width:28, align:"left",   color:[30,100,180]},
        {text: student.name,                       width:58, align:"left",   color:[20,20,20]},
